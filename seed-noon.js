...
async function seed() {
  ...
  // Find "نون" category (must exist already)
  const category = await Category.findOne({ slug: 'noon' });
  if (!category) {
    console.error('❌ Category "noon" not found. Please create it first.');
    process.exit(1);
  }

  // Upsert product
const product = await Product.findOneAndUpdate(
  { title: 'بطاقة نون 1000 ريال' },
  {
    category: category._id,
    title: 'بطاقة نون 1000 ريال',
    brief: 'بطاقة رقمية لمتجر نون – استلم الكود فوراً واشتري من ملايين المنتجات في السعودية',
    description: 'بطاقة نون الرقمية هي الحل الأمثل للتسوق عبر منصة نون، واحدة من أكبر منصات التسوق الإلكتروني في الشرق الأوسط. اشحن رصيدك بسهولة واستمتع بالتسوق من بين ملايين المنتجات في مختلف الفئات كالإلكترونيات، الأزياء، المنزل، والجمال. اختر الفئة المناسبة واستلم الكود رقمياً فور إتمام الدفع، دون الحاجة للانتظار أو الشحن. مثالية كهدية لأصدقائك وعائلتك في أي مناسبة.',
    details: {
      'العلامة': 'نون',
